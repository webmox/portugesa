...
/*-----------добавляем поддержку миниатюр для категорий------------*/
...
function add_custom_sizes() {
    ...
    add_image_size('img-news', 215, 175, true);
    add_image_size('img-icon', 100, 100, true);
    add_image_size('img-review', 195, 195, true);
    add_image_size('img-cond', 260, 160, true);
}
...
function my_mce4_options($init) {
  ...
  $custom_colours =  '"e0b36f", "Corporative color 1",
                      "2e2e2e", "Corporative color 2"';
...
/*----------------------footer---------------*/
register_sidebar(array(
        'name' => "Блок в футере 1",
        'id' => 'footer1',
        'description' => 'Этот виджет будет показан в нижней части сайта',
        'class'=>'list-page',
